...
目前的最新版本是 `v1.0.0 "Vega"`。可以从 [官方网站](https://hoshinoweaver.springcitystudio.top/) 或 [GitHub Release 页](https://github.com/Designerspr/HoshinoWeaver/releases) 获取。下载安装后，双击运行 `HoshinoWeaver.exe` 即可启动图形界面。
